...
build: sync-assets
	...
	$(GO) build ./plugins/sigil-plugin-jetbrains/
...
install: build
	$(GO) install ./cmd/sigild/ ./cmd/sigilctl/ ./plugins/sigil-plugin-claude/ ./plugins/sigil-plugin-github/ ./plugins/sigil-plugin-jira/ ./plugins/sigil-plugin-vscode/ ./plugins/sigil-plugin-jetbrains/
	@echo ""
